...
from swimrs.prep import get_flux_sites, COLUMN_MULTIINDEX, ACCEPTED_UNITS_MAP
...
if not os.path.isdir(root):
    ...
    data = os.path.join(root, 'examples', project, 'data')
...
def prep_earthengine_extracts():
    from swimrs.prep.remote_sensing import sparse_time_series
...
def join_remote_sensing_data():
    from swimrs.prep.remote_sensing import join_remote_sensing
