...
def optimize_fields(ini_path, debug_flag=False, field_type='irrigated',
                    target_fields=None, project='tongue'):
...
if __name__ == '__main__':
    ...
    optimize_fields(ini_path=ini, debug_flag=False, field_type=field_type,
