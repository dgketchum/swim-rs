...
def debug_calibration(conf_path, project_ws, fid, out_csv, params=None, pdc_file=None):
    ...
    builder = PestBuilder(project_ws=project_ws_, config_file=conf_path, use_existing=True)
...
if __name__ == "__main__":
    ...
    debug_calibration(
        config_file, project_ws_, site_, params=add_params, out_csv=out_csv, pdc_file=pdc_
    )
