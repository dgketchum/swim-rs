...
def extract_remote_sensing(conf, sites):
    ...
    sparse_sample_ndvi(conf.footprint_shapefile_shp, bucket=conf.ee_bucket, debug=False, satellite='landsat',
    ...
    sparse_sample_ndvi(conf.footprint_shapefile_shp, bucket=conf.ee_bucket, debug=False, satellite='sentinel',
