...
def extract_snodas(conf):
    ...
    sample_snodas_swe(conf.gridmet_mapping_shp, conf.ee_bucket, debug=False, check_dir=None,
...
def extract_gridmet(conf, sites):
    ...
    download_gridmet(conf.gridmet_mapping_shp, conf.gridmet_factors, conf.met, start='1987-01-01', end='2024-12-31',
